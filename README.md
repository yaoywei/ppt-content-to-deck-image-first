...
description: 中文公司宣传 PPT 一键生成（领导汇报 / 政企 / 党政 / 央国企 / 16 种视觉风格 + 7 张商务图表），3-phase cover-pick loop，不锁风格。
install: curl -fsSL https://raw.githubusercontent.com/yaoywei/ppt-content-to-deck-image-first/main/install.sh | bash
triggers: "用 ppt-content-to-deck-image-first 风格做 PPT", "给领导看", "领导汇报", "政企风格", "参考这份 PPT 的风格", "做成 PPT", "首图选风格", "公司简介 PPT", "商务图表", "dashboard", "数据可视化"
audience: 中文公司 (路演 / 政企 / 党政 / 央国企 / 商业计划 / 项目介绍 / 茶酒文旅 / 教育母婴 / 银行工业 / 美妆AI / 营销培训)
tldr: 输入公司内容，AI 出 3 张候选封面让你挑，再批量出剩下 10-15 页，最后拼成 .pptx/.pdf。覆盖 16 种视觉风格 + 7 张商务图表 dashboard, 一行命令装上，10 秒上手。
-->
<!-- AI-AGENT-META-END -->

# ppt-content-to-deck-image-first

**中文公司宣传 PPT 一键生成 · 3-phase cover-pick loop · 16 种风格 + 7 张商务图表**
...
| ![教育母婴](examples/style-watercolor-soft-4kids.jpg) | ![商务图表-业绩](examples/dashboards/style-business-dashboard-1-revenue.jpg) | ![工业制造](examples/style-blueprint-4factory.jpg) |
| **教育 / 母婴 / 心理 / 公益** | **🏢 商务图表 / 数据可视化** | **工业 / 制造 / 工程 / 能源** |
| 暖色+水彩+童趣 | 5 种图表 1 页展示 | 蓝底+技术线条+数据 |
...
| ![AI Web3](examples/style-neon-glassmorphism-4ai.jpg) | ![商务图表-运维](examples/dashboards/style-business-dashboard-5-system.jpg) | ![国央企](examples/dashboards/style-business-dashboard-3-quarterly.jpg) |
| **SaaS / AI / Web3** | **🏢 商务图表 / 运维监控** | **🏢 商务图表 / 国企汇报** |
| 紫底+毛玻璃+霓虹 | 黑底+霓虹仪表 | 白底+蓝橙+几何 |
| ![公司概况](examples/p02-company-overview.png) | ![使命定位](examples/p03-mission-positioning.png) | ![培训SOP](examples/style-hand-drawn-edu-4training.jpg) |
| **领导汇报 · P2 公司概况** | **领导汇报 · P3 使命定位** | **培训 / SOP / 教程** |
| 左图右文 50/50 + 固定页眉 | 3 段 label+body 块 | 手绘+童趣+SOP |
...
**7 张高密度图表 dashboard**，每张 = 1 张完整 PPT 内容页。重点：**真实可读的图表（KPI / 柱状 / 折线 / 饼图 / 漏斗 / 仪表盘 / 堆叠条 / 同比对比）+ 4 种视觉风格**。

| 主题 | 风格 | 看点 |
|---|---|---|
| [📊 年度业绩仪表盘](examples/dashboards/style-business-dashboard-1-revenue.jpg) | 商务白底 (Light Clean) | 4 KPI + 柱状 + 折线 + 饼图 + 堆叠条 |
| [📊 用户增长漏斗](examples/dashboards/style-business-dashboard-2-funnel.jpg) | 商务白底 (Light Clean) | 4 KPI + 漏斗 + 转化率 + 同比柱状 |
| [📊 季度业绩总览](examples/dashboards/style-business-dashboard-3-quarterly.jpg) | 蓝橙几何 (Corporate Memphis) | 4 KPI + 堆叠柱 + 仪表盘 + 区域排名 |
| [📊 成本结构拆解](examples/dashboards/style-business-dashboard-4-cost.jpg) | 蓝橙几何 (Corporate Memphis) | 4 KPI + 5 段甜甜圈 + 5 进度条 + 6 月趋势 |
| [📊 系统运行状态](examples/dashboards/style-business-dashboard-5-system.jpg) | 黑底霓虹 (Dark Dashboard) | 4 KPI + QPS 面积图 + 服务延迟 + 区域错误率 |
| [📊 流量趋势分析](examples/dashboards/style-business-dashboard-6-traffic.jpg) | 黑底霓虹 (Dark Dashboard) | 4 KPI + 30 天堆叠面积 + 来源 TOP 5 + 设备分布 |
| [📊 投资组合配置](examples/dashboards/style-business-dashboard-7-portfolio.jpg) | 米黄金 (Elegant Serif) | 4 KPI + 资产配置饼图 + 12 月收益 + 前 5 持仓 |

**客户用了之后**：每页能装下 4-5 种图表的"咨询级 dashboard"—— 政企汇报、投行季报、运营周报、产品月报都能直接出。
...
| **国企 / 银行 / 央企 / 保险 商务汇报** | Corporate Memphis + Dashboard 季度业绩总览 |
| **工业 / 制造 / 工程 / 能源** | Blueprint |
| **高端 / 奢侈品 / 私人银行** | Elegant Serif |
| **文艺 / 家居 / 服饰 / 美学** | Morandi Journal |
| **二次元 / 美妆 / 女性向** | Kawaii |
| **SaaS / AI / Web3** | Neon Glassmorphism |
| **数据大屏 / 监控 / 运维** | Dark Mode Dashboard + Dashboard 系统运行状态 |
| **商务 / 咨询 / 投行 / 季度汇报** | Light Mode Clean + Dashboard 年度业绩仪表盘 |
...
| "银行" / "国企" / "保险" / "央企" | 默认 Corporate Memphis + Dashboard 季度业绩 |
| "工业" / "制造" / "能源" / "工程" | 默认 Blueprint 风格 |
| "AI" / "SaaS" / "Web3" | 默认 Neon Glassmorphism 风格 |
| "培训" / "SOP" / "教程" | 默认 Hand-drawn Edu 风格 |
| "商务图表" / "dashboard" / "数据可视化" / "投行季报" | 默认 Light Mode Clean + Dashboard 业绩 |
...
│   ├── style-hand-drawn-edu-4training.jpg            # 培训 4 大模块
│   ├── style-showcase-*.png                          # 21 风格 PIL 索引页（备用）
│   ├── ...
│   └── dashboards/                                   # 🏢 商务图表样图（7 张 dashboard）
│       ├── style-business-dashboard-1-revenue.jpg    # 年度业绩仪表盘
│       ├── style-business-dashboard-2-funnel.jpg     # 用户增长漏斗
│       ├── style-business-dashboard-3-quarterly.jpg  # 季度业绩总览
│       ├── style-business-dashboard-4-cost.jpg       # 成本结构拆解
│       ├── style-business-dashboard-5-system.jpg     # 系统运行状态
│       ├── style-business-dashboard-6-traffic.jpg    # 流量趋势分析
│       └── style-business-dashboard-7-portfolio.jpg  # 投资组合配置
