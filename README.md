...
![封面](examples/cover-red-diagonal.webp)

**P2 公司概况（左图右文 50/50 + 固定页眉）：**

![公司概况](examples/p02-company-overview.webp)

**P3 使命定位（3 段 label+body 块，无装饰）：**

![使命定位](examples/p03-mission-positioning.webp)

**P4 资质荣誉（证书墙 2 行 3+5）：**

![资质荣誉](examples/p04-qualifications.webp)
...
### 3. 更多可选风格（**正向样图，用来快速判断方向**）

如果不是领导汇报，也可以从下面这些风格里挑方向；这些是可复用的本地样图，**不用重新花钱生成**。

| 风格 | 适用场景 | 样图 |
|---|---|---|
| HUD 科技大屏 | 科技路演 / 数据平台 / 无人机 | ![HUD 科技大屏](examples/style-showcase-hud.webp) |
| 商业路演 | 投资人 / 商业计划 / 产品发布 | ![商业路演](examples/style-showcase-pitch.webp) |
| 领导汇报 | 政企 / 党政 / 央国企 | ![领导汇报](examples/style-showcase-leadership.webp) |
| 赛博霓虹 | AI / 科技 / 活动主视觉 | ![赛博霓虹](examples/style-showcase-cyberpunk-neon.webp) |
| 技术蓝图 | 硬件 / 工程 / 技术方案 | ![技术蓝图](examples/style-showcase-technical-schematic.webp) |
| 企业孟菲斯 | 轻商务 / 培训 / 内部分享 | ![企业孟菲斯](examples/style-showcase-corporate-memphis.webp) |

> 内部踩坑与反例不放公开 README；相关经验保留在 `SKILL.md` 和 `references/` 中，避免用户转发时看到负面样例。
...
完整的 `kunpeng-yihang-v4-leadership-style.pptx` 和 PDF 属于较大的二进制交付物，不直接放在主仓库里；发布后请在 GitHub Release 下载：

- `kunpeng-yihang-v4-leadership-style.pptx`
...
│   ├── cover-red-diagonal.webp                       # 领导汇报风封面
│   ├── p02-company-overview.webp                     # 领导汇报风 P2
│   ├── p03-mission-positioning.webp                  # 领导汇报风 P3
│   ├── p04-qualifications.webp                       # 领导汇报风 P4
│   ├── style-showcase-leadership.webp                # 领导汇报风格总览
│   ├── style-showcase-hud.webp                       # HUD 科技大屏风格
│   ├── style-showcase-pitch.webp                     # 商业路演风格
│   └── style-showcase-*.webp                         # 更多正向风格样图
